...
public class GoogleTranslate {
    ...
    public static void main(String[] args) {
        ...
        GoogleTranslate translator = new GoogleTranslate("AIzaSyDPMyNemf6lMzaiqdnAE3yw0QhvNgzsxw8");
        String text = translator.translte("bahay", "fr", "en");
